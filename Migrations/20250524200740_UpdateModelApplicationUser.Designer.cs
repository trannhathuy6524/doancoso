...
namespace GotoCarRental.Migrations
{
    ...
    [Migration("20250524200740_UpdateModelApplicationUser")]
    partial class UpdateModelApplicationUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GotoCarRental.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("DriverLicenseName")
                        .HasMaxLength(100)
                    ...
                    b.Property<string>("IdentityCardImageBase64")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("GotoCarRental.Models.CarRideAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GotoCarRental.Models.DriverAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GotoCarRental.Models.Rental", b =>
                {
                    ...
                    b.Property<bool>("IsDriverRequested")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("GotoCarRental.Models.ScheduleAvailability", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GotoCarRental.Models.CarRideAssignment", b =>
                {
                    b.HasOne("GotoCarRental.Models.ApplicationUser", "Driver")
                        .WithMany()
                        .HasForeignKey("DriverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GotoCarRental.Models.Car", "Ride")
                        .WithMany()
